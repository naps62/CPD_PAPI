/*
* File:    perfmon-ia64.c
* CVS:     $Id: perfmon-ia64.c,v 1.8 2011/09/15 00:46:22 jagode Exp $
* Author:  Philip Mucci
*          mucci@cs.utk.edu
* Mods:	   Kevin London
*	   london@cs.utk.edu
...
_ia64_init_substrate( int cidx )
{
	...
	strcpy( MY_VECTOR.cmp_info.name,
			"$Id: perfmon-ia64.c,v 1.8 2011/09/15 00:46:22 jagode Exp $" );
	strcpy( MY_VECTOR.cmp_info.version, "$Revision: 1.8 $" );
