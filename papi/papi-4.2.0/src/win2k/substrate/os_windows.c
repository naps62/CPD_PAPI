/* 
* File:    os_windows.c
* CVS:     $Id: os_windows.c,v 1.5 2009/09/10 20:21:16 terpstra Exp $
* Author:  dan terpstra
*          terpstra@cs.utk.edu
* Mods:    <name>
*		   <email address>
...
int _papi_hwd_init_substrate(papi_vectors_t *vtable)
{
  ...
  model = (int) _papi_hwi_system_info.hw_info.model;
   ...
   strcpy(_papi_hwi_system_info.sub_info.name, "$Id: os_windows.c,v 1.5 2009/09/10 20:21:16 terpstra Exp $");
   strcpy(_papi_hwi_system_info.sub_info.version, "$Revision: 1.5 $"); // cvs revision of this file
   dh = pmc_open();
