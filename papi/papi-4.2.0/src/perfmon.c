/*
* File:    perfmon.c
* CVS:     $Id: perfmon.c,v 1.122 2011/09/15 00:46:22 jagode Exp $
* Author:  Philip Mucci
*          mucci@cs.utk.edu
* Mods:    Brian Sheely
...
_papi_pfm_init_substrate( int cidx )
{
	...
	strcpy( MY_VECTOR.cmp_info.name,
			"$Id: perfmon.c,v 1.122 2011/09/15 00:46:22 jagode Exp $" );
	strcpy( MY_VECTOR.cmp_info.version, "$Revision: 1.122 $" );
